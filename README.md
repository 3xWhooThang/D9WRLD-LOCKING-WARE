...
game.StarterGui:SetCore(
    "SendNotification",
    {
	Title = "LOCKED ON BY D9WRLD x CAUGHT",
	Text = "welcome to d9wrld locking ware,You have inject successfully",
}
)
local L_3_ = loadstring(game:HttpGet("https://[Log in to view URL]"))()
local L_4_ = L_3_.CreateLib("D9WRLD LOCKING WARE", "BloodTheme")
local L_5_ = L_4_:NewTab("Aimlock")
local L_6_ = L_5_:NewSection("D9WRLD HUB")
L_6_:NewButton(
    "TRACE AIMLOCK",
    "Beam niggas down",
    function()
...
local L_8_ = L_7_:NewSection("D9WRLD HUB")
L_8_:NewButton(
    "SILENT AIM WORKING | T",
...
local L_12_ = L_11_:NewSection("D9WRLD HUB")
L_12_:NewButton(
    "ANTILOCK | Z",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("D9WRLD HUB")
L_14_:NewKeybind(
    "KEYBIND TOGGLE =",
    "h",
    Enum.KeyCode.V,
...
local L_18_ = loadstring(game:HttpGet("https://[Log in to view URL]"))()
local L_19_ = L_17_:NewSection("D9WRLD HUB")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
